...
const BOOSTERS_INVENTORY = {
  ...
  'team up': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  ...
  'chilling reign': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'evolving skies': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'celebrations': { boosterBoxes: 0, cases: 0, etbs: 1, upc: 1 },
  'fusion strike': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'brilliant stars': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'astral radiance': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'lost origin': { boosterBoxes: 4, cases: 0, etbs: 0, upc: 0 },
  'silver tempest': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'scarlet & violet base set': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'paldea evolved': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'obsidian flames': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'pokemon 151': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'paradox rift': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'temporal forces': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'twilight masquerade': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'stellar crown': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'surging sparks': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'journey together': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
  'destined rivals': { boosterBoxes: 2, cases: 0, etbs: 0, upc: 0 },
  'black bolt': { boosterBoxes: 0, cases: 0, etbs: 1, upc: 0 },
  'mega evolution base set': { boosterBoxes: 1, cases: 0, etbs: 0, upc: 0 },
  'phantasmal flames': { boosterBoxes: 3, cases: 0, etbs: 0, upc: 0 },
  'perfect order': { boosterBoxes: 0, cases: 0, etbs: 0, upc: 0 },
